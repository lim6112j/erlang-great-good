...
lastnames() ->
  ["Frizzle", "Perlstein", "Ramon", "Ann", "Franklin", "Terese", "Tenneli", "Jamal", "Li", "Perlstein"].
...
terminate(bad_note, S) ->
  io:format("~s sucks! kicked that member out of the bank! (~s)~n", [S#state.name, S#state.role]);
